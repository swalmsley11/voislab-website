      ...
      <div className="legal-container">
        ...
        <div className="legal-content">
          ...
          <section className="legal-section">
            ...
            <p>
              VoisLab ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy 
          ...
          <section className="legal-section">
            ...
            <p>
              When you stream audio content on our website, we may collect information about your 
              listening preferences, playback duration, and technical performance data to improve 
              our streaming quality and user experience.
            </p>
          </section>
          ...
          <section className="legal-section">
            ...
            <p>
              Our website may contain links to third-party streaming platforms (Spotify, Apple Music, 
              SoundCloud, etc.). We are not responsible for the privacy practices of these external services. 
