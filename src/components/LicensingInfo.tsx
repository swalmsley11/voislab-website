      ...
      <div className="legal-container">
        ...
        <div className="legal-content">
          ...
          <section className="legal-section">
            ...
            <p>
              VoisLab offers various licensing options for our original audio content. All music 
              and audio compositions are created by our team and are available for licensing 
          ...
          <section className="legal-section">
            ...
            <div className="license-type">
              ...
              <p>
                Free for personal, non-commercial use including:
              </p>
              <ul>
            ...
            <div className="license-type">
              ...
              <p><strong>Contact us for pricing and terms.</strong></p>
            </div>

            <div className="license-type">
              <h3>Sync License</h3>
              <p>
                For synchronization with visual media:
              </p>
              <ul>
              ...
              <p><strong>Custom licensing available based on project scope.</strong></p>
            </div>

            <div className="license-type">
              <h3>Exclusive License</h3>
              <p>
                For exclusive rights to specific tracks:
              </p>
              <ul>
              ...
              <p><strong>Premium pricing for exclusive arrangements.</strong></p>
            </div>
          </section>
          ...
          <section className="legal-section">
            ...
            <p>
              Proper attribution is required for all licensed content:
            </p>
            <div className="attribution-example">
              <p><strong>Standard Attribution:</strong></p>
              <p>"Music by VoisLab - [Track Title] - Licensed under [License Type]"</p>
            </div>
            <p>
              For commercial projects, attribution placement and format may be negotiated 
          ...
          <section className="legal-section">
            ...
            <p>
              VoisLab also offers custom music composition services for specific projects. 
          ...
          <section className="legal-section">
            ...
            <ol>
              ...
              <li>Implement with confidence knowing you're properly licensed</li>
            </ol>
          </section>
          ...
          <section className="legal-section">
            ...
            <p>
              Ready to license our music for your project? Get in touch:
            </p>
            <p>Email: licensing@voislab.com</p>
            <p>Phone: +1 (555) 123-4567</p>
            <p>
              Please include details about your project, intended use, distribution scope, 
              and timeline for the fastest response.
            </p>
          </section>
        </div>
      </div>
